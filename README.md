...
- **NumPy Integration**: Uses vectorized operations for board state evaluation.
...
When *alpha >= beta*, the algorithm "prunes" (discards) the remaining branches, as they cannot influence the final decision.